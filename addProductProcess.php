...
// echo("INSERT INTO `product`(`price`,`qty`,`description`,`title`,`datetime_added`, `delivery_fee_colombo`,`delivery_fee_other`,`category_cat_id`,`model_has_brand_id`,`color_clr_id`,`status_status_id`,`condition_condition_id`,`users_email`) VALUES ('".$cost."','".$qty."','".$desc."','".$title."','".$date."','".$dwc."','".$doc."','".$category."','".$mhb_id."','".$clr."','".$status."','".$condition."','".$email."')");
    ...
    for($x = 0;$x < $length;$x++){
        if(isset($_FILES["img".$x])){
            ...
            if(in_array($file_extention,$allowed_img_extentions)){
                ...
                $file_name = "resourses//clothing_imgs//".$title."_".$x."_".uniqid().$new_img_extention;

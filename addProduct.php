...
<head>
    ...
    <title>Add Product | MODALINE</title>
                ...
                <div class="col-12" >
                    <div class="row">
                        ...
                        <div class="col-12 text-center" >
                            <h2 class="h2 text- fw-bold" style="margin-top: 50px;">Add New Product</h2>
                        </div>
                                        ...
                                        <div class="offset-lg-3 col-12 col-lg-6">
                                            <div class="row">
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resourses/Add Image.svg" class="img-fluid" style="width: 250px;" id="i0" />
                                                </div>
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resourses/Add Image.svg" class="img-fluid" style="width: 250px;" id="i1" />
                                                </div>
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resourses/Add Image.svg" class="img-fluid" style="width: 250px;" id="i2" />
                                                </div>
                                            </div>
                                        </div>
